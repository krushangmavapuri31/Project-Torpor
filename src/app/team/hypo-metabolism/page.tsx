...
import { hypoMetabolismMembers } from "@/lib/team-data";

export const metadata: Metadata = {
  title: "Team Hypo Metabolism",
  description:
    "A multidisciplinary team focused on researching synthetic torpor metabolic suppression pathways and physiological adaptation.",
};

export default function HypoMetabolismPage() {
  return (
    <>
      <PageHero
        title="TEAM HYPO METABOLISM"
        subtitle="A multidisciplinary team focused on researching synthetic torpor metabolic suppression pathways and physiological adaptation."
          ...
          <div className="mt-14 grid grid-cols-1 md:grid-cols-3 gap-8">
            <FadeIn direction="up" delay={0.1}>
              <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] h-full transition-transform hover:-translate-y-1 duration-300">
                ...
                <p className="text-slate-500 text-sm leading-relaxed">
                  Researching pathways to safely reduce metabolic rates in human subjects.
                </p>
              </div>
            </FadeIn>
            ...
            <FadeIn direction="up" delay={0.2}>
              <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] h-full transition-transform hover:-translate-y-1 duration-300">
                ...
                <p className="text-slate-500 text-sm leading-relaxed">
                  Studying bodily responses and adaptations during prolonged torpor states.
                </p>
              </div>
            </FadeIn>
            ...
            <FadeIn direction="up" delay={0.3}>
              <div className="bg-white p-8 rounded-2xl border border-slate-100 shadow-[0_8px_30px_rgba(0,0,0,0.04)] h-full transition-transform hover:-translate-y-1 duration-300">
                ...
                <p className="text-slate-500 text-sm leading-relaxed">
                  Exploring targeted temperature management and active cooling techniques.
                </p>
              </div>
            </FadeIn>
          </div>
          <div className="mt-20">
            <TeamGrid members={hypoMetabolismMembers} />
          </div>
        </div>
      </section>
    </>
